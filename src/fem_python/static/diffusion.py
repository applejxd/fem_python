...
import numpy as np
from skfem import (Basis, BilinearForm, ElementTriP1, MeshTri, asm, condense,
                   solve)
...
mesh_path = utils.download_file(
    "https://github.com/kinnala/scikit-fem/raw/master/docs/examples/meshes/cylinder_stokes.msh"
)
mesh = MeshTri.load(mesh_path)
