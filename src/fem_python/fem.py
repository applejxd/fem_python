...
def main():
    ...
    url = r"https://github.com/sfepy/sfepy/raw/master/meshes/2d/rectangle_tri.mesh"
    ...
    gamma1 = domain.create_region(
        "Gamma1", "vertices in x < %.10f" % (min_x + eps), "facet"
    )
    gamma2 = domain.create_region(
        "Gamma2", "vertices in x > %.10f" % (max_x - eps), "facet"
    )
